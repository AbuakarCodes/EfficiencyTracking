        ...
        <div className=" gap-4 flex flex-col md:flex-row">
          ...
          <div className="flex flex-col w-full md:w-1/2">
            ...
            <input
              ...
              name="periodA"
              type={type}
              className="w-full border focus:outline-none focus:ring-0 border-black/30 px-3 py-2 rounded-b text-black bg-white focus:outline-none focus:ring-2 focus:ring-black"
            />
          </div>
