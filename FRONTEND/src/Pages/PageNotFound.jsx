          ...
          <section className=" h-[90vh] flex justify-center items-center">
              <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                  <div className="mx-auto max-w-screen-sm text-center">
                      ...
                      <NavLink to="/" className="inline-flex  border border-black bg-primary-600 bg-black text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4">Back to Homepage</NavLink>
                  </div>   
              </div>
          </section>
        </>
